...
.c-button {
  ...
  background: v-bind('variantTheme.backgroundColor');
  display: inline-flex;
  flex-direction: row;
  align-items: center;
  ...
  &:not(.disabled) {
    &:hover {
      background: v-bind('variantTheme.hover.backgroundColor');
    }

    &:active {
      background: v-bind('variantTheme.pressed.backgroundColor');
    }
  }
