...
<template>
  ...
  >
    ...
    <div class="feedback-wrapper">
      <div ref="inputWrapperRef" class="input-wrapper u-input">
        <slot name="prefix" />
...
.c-input-text {
  ...
  .feedback-wrapper { flex: 1 1 0; min-width: 0; }
  ...
  .input-wrapper {
    ...
    .multiline& { resize: vertical; overflow: hidden; }
    ...
    & > textarea {
      ...
      &::placeholder { color: v-bind('appTheme.text.mutedColor'); }
    }
    ...
    &:hover { border-color: v-bind('theme.focus.borderColor'); }
    &:focus-within { border-color: v-bind('theme.focus.borderColor'); background: v-bind('theme.focus.backgroundColor'); box-shadow: 0 0 0 2px rgba(19, 80, 88, 0.2); }
  }

  &.error .input-wrapper { border-color: v-bind('appTheme.error.color'); }
  &.disabled .input-wrapper { opacity: 0.5; }
}
</style>
