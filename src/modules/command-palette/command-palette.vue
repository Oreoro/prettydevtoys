...
<template>
  <div flex-1>
    ...
    <c-modal v-model:open="isModalOpen" class="palette-modal" shadow-xl important:max-w-700px important:pa-12px @keydown="handleKeydown">
      <c-input-text ref="inputRef" v-model:value="searchPrompt" raw-text placeholder="Type to search a tool or a command..." autofocus clearable />

      <div v-for="(options, category) in filteredSearchResult" :key="category">
        <div ml-3 mt-3 text-sm font-bold op-60 style="background: var(--badge-bg); -webkit-background-clip: text; color: transparent;">
          {{ category }}
        </div>
